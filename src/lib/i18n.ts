...
export const dict: Record<Locale, Dict> = {
  en: {
    ...
    faq: {
      ...
      chooseIntro: "A few things could match that. Which did you mean?",
      topicsIntro: "I couldn't quite place that question. Pick a topic and I'll show what's there:",
      topicPick: "Here's what we cover under that topic:",
      noMatch: "I don't have an answer for that one.",
      contactIntro: "Our team can help you directly:",
      allTopics: "Show all topics", empty: "No questions have been published yet.",
    },
    booking: {
      ...
      video: {
        ...
        watchFirst: "Please watch the video to the end to continue.",
        ack: "I have watched the video and understood the safety instructions.",
        watched: "Video watched",
        unavailable: "The safety video could not be loaded. You can continue with your booking — our staff will go through the safety instructions with you at pick-up.",
      },
      noc: {
  ...
  ja: {
    ...
    faq: {
      ...
      placeholder: "ご質問を入力してください…", send: "送信", close: "閉じる",
      chooseIntro: "いくつか該当しそうな項目があります。どちらでしょうか？",
      topicsIntro: "ご質問を特定できませんでした。トピックをお選びください：",
      topicPick: "このトピックでは次の内容をご案内しています：",
      noMatch: "そのご質問にお答えできる項目が見つかりませんでした。",
      contactIntro: "スタッフが直接ご対応いたします：",
      allTopics: "すべてのトピックを表示", empty: "公開中のご質問はまだありません。",
    },
    booking: {
      heading: "予約する",
      ...
      video: {
        ...
        watchFirst: "最後まで動画をご覧いただくと、次に進めます。",
        ack: "動画を視聴し、安全上の注意を理解しました。",
        watched: "視聴済み",
        unavailable: "安全動画を読み込めませんでした。このままご予約を進めていただけます。お受け取り時にスタッフが安全上のご案内をいたします。",
      },
      noc: {
  ...
  zh: {
    ...
    faq: {
      ...
      placeholder: "请输入您的问题…", send: "发送", close: "关闭",
      chooseIntro: "有几项可能符合您的问题，您指的是哪一项？",
      topicsIntro: "未能理解您的问题。请选择一个主题：",
      topicPick: "该主题包含以下内容：",
      noMatch: "暂时找不到该问题的答案。",
      contactIntro: "我们的团队可以直接为您提供协助：",
      allTopics: "显示全部主题", empty: "尚未发布任何问题。",
    },
    booking: {
      heading: "预订车辆",
      ...
      video: {
        ...
        watchFirst: "请完整观看视频后继续。",
        ack: "我已观看视频并理解安全须知。",
        watched: "已观看",
        unavailable: "安全视频加载失败。您可以继续完成预订，取车时我们的工作人员会为您讲解安全须知。",
      },
      noc: {
        title: "NOC（营业损失费）",
  ...
  ko: {
    ...
    faq: {
      ...
      placeholder: "질문을 입력하세요…", send: "보내기", close: "닫기",
      chooseIntro: "몇 가지 항목이 해당될 수 있습니다. 어느 것을 말씀하시나요?",
      topicsIntro: "질문을 정확히 파악하지 못했습니다. 주제를 선택해 주세요:",
      topicPick: "이 주제에서는 다음 내용을 안내하고 있습니다:",
      noMatch: "해당 질문에 대한 답변을 찾지 못했습니다.",
      contactIntro: "담당 직원이 직접 도와드립니다:",
      allTopics: "전체 주제 보기", empty: "아직 등록된 질문이 없습니다.",
    },
    booking: {
      heading: "차량 예약",
      ...
      video: {
        ...
        watchFirst: "영상을 끝까지 시청하시면 다음으로 진행할 수 있습니다.",
        ack: "영상을 시청했으며 안전 안내를 이해했습니다.",
        watched: "시청 완료",
        unavailable: "안전 영상을 불러오지 못했습니다. 예약은 그대로 진행하실 수 있으며, 픽업 시 직원이 안전 안내를 도와드립니다.",
      },
      noc: {
        title: "NOC(휴차 보상료)",
